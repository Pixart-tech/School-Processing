...
def _build_school_folder_name(school_id: str, school_name: str) -> str:
    sanitized_id = _sanitize_filename_component(school_id, "school")
    sanitized_name = _sanitize_filename_component(school_name, "school")
    return f"{sanitized_id}_{sanitized_name}"
